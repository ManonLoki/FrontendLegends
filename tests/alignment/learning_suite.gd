...
static func run(tree: SceneTree, assert_true: Callable) -> void:
	...
	for test_case in [[basic, 1, 60], [basic, 40, 840], [basic, 100, 4000], [sect, 1, 100], [sect, 40, 880], [sect, 100, 6000]]:
	...
	assert_true.call(samples == [{"required": 240, "ticks": 30, "potential": 30, "token": 20}, {"required": 240, "ticks": 24, "potential": 24, "token": 16}, {"required": 240, "ticks": 18, "potential": 18, "token": 12}], "灵感0/25/50的10级学习经济应精确为30/24/18潜能与20/16/12 Token")
