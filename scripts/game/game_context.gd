...
const SETTINGS_CONTROLLER := preload("res://scripts/game/settings/settings_controller.gd")
...
var settings_controller := SETTINGS_CONTROLLER.new(self)
...
var player_foot_anchors: Dictionary = {}
...
const SKILL_ITEMS := ["冥想", "练功", "加力", "功法", "传送"]
const SYSTEM_ITEMS := ["摸鱼", "疗伤", "保存", "设置"]
